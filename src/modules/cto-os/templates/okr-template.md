...
**Quarter**: [YYYY QX]
**Team/Organization**: [Engineering / Platform Team / Product Team]
**Owner**: [CTO / VP Engineering / Director]

---

## OKR Framework

**Objective**: What we want to achieve (qualitative, inspirational, time-bound)
...
**Target**: Aim for 0.7 average - if consistently hitting 1.0, OKRs aren't ambitious enough

---

## Objective 1: [Inspirational Goal Statement]

**Why This Matters**: [Connection to business strategy]
**Owner**: [Name]
**Priority**: P0 (Must Have) / P1 (Should Have) / P2 (Nice to Have)

### Key Result 1.1: [Specific Measurable Outcome]

**Current Baseline**: [Starting metric]
**Target**: [End goal]
...
**Objective 1 Final Score**: [Average of KRs]

---

## Objective 2: [Inspirational Goal Statement]

[Same format as Objective 1]

---

## Objective 3: [Inspirational Goal Statement]
...
- Source: Manager tracking + HR system
...
**Risk Assessment**:
🟢 **Low Risk**: [KR 1.1, KR 2.3] - Clear path, low dependencies
🟡 **Medium Risk**: [KR 1.2, KR 3.1] - Some unknowns, manageable
🔴 **High Risk**: [KR 2.2] - Significant technical challenges, external dependencies
...
**On Track** (0.7+ confidence): [List KRs]
**At Risk** (0.4-0.6 confidence): [List KRs]
...
**Do**:
✅ Set ambitious but achievable targets (aim for 0.7)
...
**Don't**:
❌ Set too many OKRs (max 3-5 per team)
❌ Make them BAU tasks (should be ambitious)
❌ Hide behind subjective metrics
❌ Set and forget (need regular check-ins)
❌ Tie directly to performance reviews
❌ Keep impossible OKRs unchanged
