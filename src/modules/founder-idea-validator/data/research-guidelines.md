...
- Identify outlier claims requiring explanation
...
## Research Methodologies by Validator
...
- Review customer reviews for pain points
...
- Cross-verify with multiple methodologies
...
- Check for price sensitivity discussions
...
- Reddit, forums (demand signals)
- Google Trends (search interest)
- Similar Web (traffic estimates)
...
- Estimate their CAC where possible
...
- Industry reports on channel effectiveness
...
- Use industry averages as directional
...
- Industry benchmark reports
- Company blog posts (how they grew)
- LinkedIn posts from founders/marketers
...
**How to communicate:**
"Insufficient data available. Recommend validation through [specific test]..."
...
- Providing validation next steps
...
- Regulatory barriers preventing entry
...
- High customer churn indicates poor fit
- Long sales cycles exceeding runway
...
**State confidence:**
"High confidence - verified from company websites (Tier 1 sources)"

**Note assumptions:**
"Assuming similar feature set; actual comparison depends on specific requirements"

### For Estimates

**Explain methodology:**
"Market size estimated using: (Target users in US: 2M) × (Average spend: $500/year) = $1B TAM"

**State assumptions:**
"Assumes 10% market penetration realistic given distribution constraints"

**Provide confidence level:**
"Medium confidence - based on industry reports and reasonable assumptions"

**Flag validation needs:**
"Validate through customer interviews to confirm spending patterns"
...
- Provide specific validation steps for uncertainties
- Use recent data (< 2 years when possible)
...
- Cherry-pick favorable data only
...
1. **Explicitly state the gap:**
   "Unable to find reliable CAC benchmarks for this specific niche"

2. **Explain why:**
   "This appears to be an emerging category with limited public data"

3. **Suggest validation approach:**
   "Recommend talking to 5-10 target customers to understand willingness to pay and acquisition channels"

4. **Provide analogous data:**
   "Similar B2B SaaS tools show CAC of $500-$2,000, which may serve as rough benchmark"

5. **Set clear success criteria:**
   "Successful validation would show CAC < $1,000 based on industry analogies"
...
- Pricing analysis with comparables
...
- [ ] All major claims have 3+ sources
- [ ] All sources include URLs
- [ ] Confidence levels are stated
- [ ] Assumptions are clearly flagged
- [ ] Data recency is noted
- [ ] Contradictory evidence is addressed
- [ ] Validation steps are provided for uncertainties
- [ ] Red flags are explicitly called out
- [ ] Analogies are noted as such
- [ ] Methodology is explained for estimates

## Remember

Research quality directly impacts validation reliability. Better to say "insufficient data" with recommended validation steps than to make unsupported claims.

**Speed matters, but accuracy matters more.** Take the 10-15 minutes to research properly rather than guessing.
