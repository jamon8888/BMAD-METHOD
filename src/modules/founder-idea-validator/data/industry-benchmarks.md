# Industry Benchmarks for Business Validation
...
**Revenue per Employee:** $100,000-$250,000+ annually
...
**LTV to CAC Ratio:** Minimum 3:1

**Repeat Purchase Rate:** 25-40% within 12 months (healthy)

**Cart Abandonment:** 60-80% (typical)

**Conversion Rate:** 1-3% (average), 3-5% (good), 5%+ (excellent)
...
**Customer Acquisition Cost:** Highly variable, referrals most cost-effective

**Utilization Rate:** 60-80% billable hours (healthy)

**Client Retention:** 70%+ annual retention (good)

### Marketplaces

**Take Rate:** 10-30% (platform commission)

**Gross Margins:** 60-80% (platform level)

**CAC:** Varies widely by side (supply vs. demand)

**GMV to Revenue:** Take rate determines conversion

**Liquidity:** Critical mass needed for both sides

**Network Effects:** Strong once established
...
**Production Costs:** High upfront, low marginal

**Subscription Retention:** 50-70% annual (content), 70-85% (education)

**Ad-Supported:** $5-$50 RPM (revenue per thousand impressions)
...
- Positive contribution margin from customer 1
...
- Negative contribution margin requiring scale
...
- Market size too small for CAC economics
- Competitors with 10x better economics
...
**Parity:** Match if comparable offering
...
**Decoy Pricing:** Three tiers to anchor middle
**Value Anchoring:** Show expensive option first
...
1. **Identify Your Model** - Which category fits closest?
2. **Set Realistic Targets** - Use benchmarks as goals, not guarantees
3. **Measure Progress** - Track your metrics against benchmarks
4. **Adjust Strategy** - If far off benchmarks, understand why
5. **Context Matters** - Consider your unique circumstances

**Remember:** Benchmarks are directional guides, not absolute rules. Use them to pressure-test assumptions and identify potential issues early.

## Warning About Benchmarks

- Industry averages include winners and losers
- Your mileage will vary based on execution
- Early-stage metrics often worse than mature businesses
- Focus on trajectory, not just current state
...
- ProfitWell's Subscription Benchmarks
